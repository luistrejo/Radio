package bulldogs.luistrejo.com.radio;
...
public class MainActivity extends Activity {
    ...
    String URL_connect="http://"+IP_Server+"/radio/acces.php";//ruta en donde estan nuestros archivos
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        registrar.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                ...
                String url = "http://"+IP_Server+"/radio/adduser.html";
    ...
    public void err_login(){
        ...
        Toast toast1 = Toast.makeText(getApplicationContext(),getString(R.string.errorlogin), Toast.LENGTH_SHORT);
        toast1.show();
    }
